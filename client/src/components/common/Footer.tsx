...
const Footer = () => {
  const footerTheme = useAppSelector((state) => state.theme.footerTheme);

  ////color schemes to alternate footer colors on diff pages
  const colorSchemes = {
    transparent: {
  ...
  const currentScheme = colorSchemes[footerTheme];
  return (
    <footer
      className={`${currentScheme.background} ${currentScheme.text} mt-auto px-6 sm:px-8 lg:px-10`}
    >
      <div className="w-full mx-auto max-w-7xl grid grid-cols-1 lg:grid-rows-2 gap-4 md:py-10 lg:py-16 ">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
          ...
          <div>
            <p className="text-lg md:text-2xl lg:text-3xl font-medium lg:font-semibold duration-1000 ease-in">
          ...
          <div className="">
            ...
            <div>
              <form method="post" className="flex items-center">
                <div>
                  <input
                    className={`border-b border-gray-400 focus:outline-none ${currentScheme.background} text-lg lg:text-2xl ${currentScheme.text}`}
                    type="email"
                    name="email"
